...
/*
  Since our express server is rendering the scripts to include in the HTML returned
  we need to produce a config with the correct file names in production
*/
